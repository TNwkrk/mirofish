...
// Step State
const currentStep = ref(1) // 1: Graph Building, 2: Environment Setup, 3: Simulation, 4: Report Generation, 5: Deep Interaction
const stepNames = ['Graph Building', 'Environment Setup', 'Simulation', 'Report Generation', 'Deep Interaction']
