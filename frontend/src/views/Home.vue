  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">A Clean, General-Purpose Swarm Intelligence Engine</span>
          ...
          <div class="hero-desc">
            <p>
              Even from just a paragraph of text, <span class="highlight-bold">MiroFish</span> can fully automatically generate a parallel world composed of up to <span class="highlight-orange">millions of Agents</span> based on the reality seeds within it. By injecting variables from a god's-eye view, it searches for a <span class="highlight-code">"local optimum"</span> in dynamic environments through complex group interactions.
            </p>
            <p class="slogan-text">
              Let the future be rehearsed in Agent swarms, let decisions prevail after countless trials<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              <div class="metric-value">High Scalability</div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent equipped with a rich toolset for deep interaction with the post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any entity in the simulated world & converse with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction needs in natural language (e.g. If Wuhan University revokes a student's disciplinary action, what public opinion trend might emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate immediately to Process page (special ID indicates new project)
    router.push({
      name: 'Process',
